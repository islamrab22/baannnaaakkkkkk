...
export default function CardRequestsPage() {
  ...
  const columns: Column<CardRequest>[] = [
    ...
    { key: "cardType", label: "Card Type", sortable: true, render: (r) => <span className="font-bold">{r.cardType}</span> },
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-black text-gray-900 dark:text-white">Card Requests</h1>
        <p className="text-xs text-gray-400 font-medium mt-1">Track and process customer credit card applications.</p>
      </div>
